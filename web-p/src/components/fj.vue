  ...
  <div class="top5">
    ...
    <div class="views">
      <div class="left">
        <div class="title">
          ...
          >
            <path
              d="M899.5 899.5h-775v-775h775v775z"
              fill="#f4ea2a"
              p-id="1569"
            ...
            ></path>
            <path
              d="M137 137v750h750V137H137m-25-25h800v800H112V112z"
              fill="#ffffff"
              p-id="1570"
      ...
      <div class="right">
        <div class="pic1">
          <img :src="login.baseApi + list.img[0]" alt="" />
        </div>
        <div class="bottonpic">
          <div class="pic2">
          ...
          <div class="pic3">
            <img :src="login.baseApi + list.img[2]" alt="" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="views">
      <div class="left">
        ...
        <br />
        <span>{{ list.content2 }}</span>
      </div>
      <div class="right">
        <div class="pic1">
          <img :src="login.baseApi + list.img[3]" alt="" />
        </div>
        <div class="bottonpic">
          <div class="pic2">
            <img :src="login.baseApi + list.img[4]" alt="" />
          </div>
          <div class="pic3">
            <img :src="login.baseApi + list.img[5]" alt="" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="views">
      <div class="left">
        ...
        <br />
        <span>{{ list.content3 }}</span>
      </div>
      <div class="right">
        <div class="pic1">
          <img :src="login.baseApi + list.img[6]" alt="" />
        </div>
        <div class="bottonpic">
          <div class="pic2">
            <img :src="login.baseApi + list.img[7]" alt="" />
          </div>
          <div class="pic3">
            <img :src="login.baseApi + list.img[8]" alt="" />
          </div>
        </div>
      </div>
    </div>
...
login
  .getViews(qs.stringify({ cityId: store.state.cityId }))
  .then(({ data }) => {
    list.name = data.data[0].viewname.split(",");
    list.content = data.data[0].content;
    list.content2 = data.data[0].content2;
    list.content3 = data.data[0].content3;
    list.img = data.data[0].img.split(",");
    list.title = data.data[0].gaikuang;
  });
</script>
